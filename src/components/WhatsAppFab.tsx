...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/25 hover:brightness-110 transition animate-floaty"
    >
